...
<div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
       ...
       <center><img src="{{asset('22.png')}}" style="padding-top: 20px; "></center>
        <div class="row"> 
          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <form class="user" action="{{url('commande/enregisterCommandeChien')}}" method="post" enctype="multipart/form-data">
              	{{ csrf_field()}}
...
<div class="col-lg-6" style="padding-top: 150px;">
  ...
  <ul>
    ...
    <li> <h4> Le prix du chien :<span class="sp"> {{$produit->prix}} DH</span></h4></li>
    
    <li> <h4>la somme total :<span class="sp"> {{$produit->prix}} DH</span> </h4></li>
    <style type="text/css">
